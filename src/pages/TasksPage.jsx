...
// Intentionally kept as a mutable module-level fixture for PR review practice.
const starterTasks = [
...
function TasksPage() {
  ...
  // Intentionally recreated on every render to leave a detectable performance smell.
  const handlers = {
